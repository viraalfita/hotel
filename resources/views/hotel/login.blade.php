  ...
  <body class="bg-light">
    <div class="container">
        <div class="bg-light mt-5 p-5" style="border-radius: 1rem;">
            ...
            <div class="card-login shadow bg-login rounded p-5 text-center m-auto">
                ...
                <div class="row">
                  <button class="col btn btn-outline-light btn-lg px-5" type="submit">Login</button>
                  <a class="col btn bg-btn-daftar btn-lg px-5 mt-2" href="/register-tamu">Daftar</a>
                </div>
                </form>
            </div>
            </div>
