...
<div class="container">
    ...
    <div class="card rounded shadow-sm bg-login border-light my-5">
        <div class="card-header">
            <h1 class="text-pink fw-bolder">Fasilitas Hotel</h1>
        </div>
        <div class="card-body">
            <div class="my-2 p-3 bg-light rounded">
                {{-- Pencarian --}}
                <div class="pb-3">
                    <form action="{{url('fasilitas-hotel')}}" class="d-flex" method="get">
                ...
                {{-- Tambah Data --}}
                <div class="pb-3">
                    <a href="{{url('fasilitas-hotel/create')}}" class="btn btn-transparent border-secondary text-pink">+ Tambah Data</a>
                </div>
                ...
                <table class="table table-secondary table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-2 text-center">Nama Fasilitas</th>
                            <th class="col-md-3 text-center">Keterangan</th>
                            <th class="col-md-4 text-center">Gambar</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$nomer++}}</td>
                            <td>{{$dat->nama_fasilitas}}</td>
                            <td>{{$dat->keterangan}}</td>
                            <td class="text-center"><img src="{{"assets/".$dat->gambar}}" alt="" height="150"></td>
                            <td class="text-center">
                                <a href='{{url('fasilitas-hotel/'.$dat->id.'/edit')}}' class="btn btn-transparent btn-sm">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form action="{{url('fasilitas-hotel/'.$dat->id)}}" method="POST">
            @csrf
            @method('DELETE')
