...
<form action="{{url('data-kamar')}}" method="POST">
@csrf
...
<div class="card my-5 bg-form shadow-sm">
    ...
    <div class="my-3 p-3 bg-form">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="tipe_kamar" id="tipe_kamar" value="{{Session::get('tipe_kamar')}}">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="jumlah_kamar" class="col-sm-2 col-form-label text-light">Jumlah Kamar</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" name="jumlah_kamar" id="jumlah_kamar" value="{{Session::get('jumlah_kamar')}}">
            </div>
        </div>
        <div class="mb-3 row">
