...
<div class="container">
    ...
    <div class="card rounded bg-login border-light my-5">
        <div class="card-header">
            <h1 class="text-pink fw-bolder">Fasilitas Kamar</h1>
        </div>
        <div class="card-body">
            <div class="my-2 p-3 bg-light rounded">
                {{-- Pencarian --}}
                <div class="pb-3">
                    <form action="{{url('fasilitas-kamar')}}" class="d-flex" method="get">
                ...
                {{-- Tambah Data --}}
                <div class="pb-3">
                    <a href="{{url('fasilitas-kamar/create')}}" class="btn btn-transparent border-secondary text-pink">+ Tambah Data</a>
                </div>
                ...
                <table class="table table-secondary table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-4 text-center">Nama Fasilitas</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href='{{url('fasilitas-kamar/'.$dat->id.'/edit')}}' class="btn btn-transparent btn-sm">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form action="{{url('fasilitas-kamar/'.$dat->id)}}" method="POST">
            @csrf
            @method('DELETE')
